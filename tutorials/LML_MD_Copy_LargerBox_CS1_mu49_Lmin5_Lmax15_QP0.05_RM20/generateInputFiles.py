...
setInputVariable('inputFiles/'+DDfile,'Nsteps','40000')  # number of simulation steps
...
setInputVariable('inputFiles/'+DDfile,'alphaLineTension','3.3') # dimensionless scale factor in for line tension forces
...
setInputVariable('inputFiles/'+DDfile,'outputFrequency','500')  # output frequency
