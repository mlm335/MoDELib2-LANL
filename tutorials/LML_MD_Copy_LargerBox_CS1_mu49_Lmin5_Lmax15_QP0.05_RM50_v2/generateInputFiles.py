...
setInputVariable('inputFiles/'+DDfile,'alphaLineTension','2.5') # dimensionless scale factor in for line tension forces
setInputVariable('inputFiles/'+DDfile,'remeshFrequency','50')
